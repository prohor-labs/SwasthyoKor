...
export function GoogleIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <title>Google</title>
      <defs>
        <linearGradient id="google_a">
          <stop offset="0" stopColor="#0fbc5c" />
          <stop offset="1" stopColor="#0cba65" />
        </linearGradient>
        <linearGradient id="google_g">
        ...
        <linearGradient id="google_d">
          <stop offset=".408" stopColor="#fb4e5a" />
          <stop offset="1" stopColor="#ff4540" />
        </linearGradient>
        <linearGradient id="google_c">
        ...
        <clipPath id="google_i" clipPathUnits="userSpaceOnUse">
